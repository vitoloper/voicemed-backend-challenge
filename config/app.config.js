...
const development = {
    ...
    redis: {
        uri: process.env.DEV_REDIS_URI || 'redis://127.0.0.1:6379/1'
    },
    bull: {
...
const production = {
    ...
    redis: {
        uri: process.env.PROD_REDIS_URI || 'redis://127.0.0.1:6379/2'
    },
    bull: {
...
const test = {
    ...
    redis: {
        uri: process.env.TEST_REDIS_URI || 'redis://127.0.0.1:6379/3'
    },
    bull: {
